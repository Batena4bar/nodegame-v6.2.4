...
module.exports = function (treatmentName, settings, stager, setup, gameRoom) {
    ...
    stager.extendStep('the_scenario_1', {
        ...
        cb: function () {
            node.set({ treatmentName: node.game.settings.treatmentName });
    ...
    stager.extendStep('the_scenario_2', {
        ...
        donebutton: {
            ...
            if (justification && justification.value) {
                node.set({ justification: justification.value });
            }
        },
        cb: function () {
            var that = this;
    ...
    stager.extendStep('the_scenario_4', {
    ...
    stager.extendStep('initial_choice', {
        ...
        donebutton: {
            ...
            node.set({ initial_choice: node.game.globals.slerValues });
        },
        cb: function () {
            // Construct infoBar
    ...
    stager.extendStep('secondary_choice', {
        ...
        donebutton: {
            ...
            node.set({ secondary_choice: node.game.globals.iderValues });
        },
        cb: function () {
            // Construct infoBar
            var infoBar = W.getElementById('info-bar');
    ...
    stager.extendStep('group_choice', {
        ...
        donebutton: {
            ...
            node.set({ group_choice: node.game.globals.slidValues, decider: node.game.globals.deciderId || node.player.id });
        },
        cb: function () {
            var choices = {};
            var that = this;
